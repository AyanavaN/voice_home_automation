...
voskmodel = Model("Vosk/vosk-model-en-in-0.5/")
voskrec = KaldiRecognizer(voskmodel, RATE)
...
# 		print("Individual speaker scores: ", scores)
	...
	if(winnerRange > -26):
		...
		with open("testing_set/test.wav", "rb") as f:
			data = f.read()
			voskrec.AcceptWaveform(data)
			res1=voskrec.FinalResult()
